...
// AHRSAndPositioningWithTimestampAndRaw Update Packet (similar to AHRSPosTS, but adds raw data)
    ...
    public static int decodeAHRSUpdate( byte[] buffer, 
        ...
        if ( (buffer[offset+0] == PACKET_START_CHAR) && 
            ...
            u.pitch = decodeProtocolSignedHundredthsFloat(buffer, offset+AHRS_UPDATE_ROLL_VALUE_INDEX);
            u.roll = decodeProtocolSignedHundredthsFloat(buffer, offset+AHRS_UPDATE_PITCH_VALUE_INDEX);
    ...
    public static int decodeAHRSPosUpdate( byte[] buffer, 
		...
		if ( (buffer[offset+0] == PACKET_START_CHAR) && 
			...
			u.pitch = decodeProtocolSignedHundredthsFloat(buffer, offset+AHRSPOS_UPDATE_ROLL_VALUE_INDEX);
			u.roll = decodeProtocolSignedHundredthsFloat(buffer, offset+AHRSPOS_UPDATE_PITCH_VALUE_INDEX);
    ...
    public static int decodeAHRSPosTSUpdate( byte[] buffer, 
		...
		if ( (buffer[offset+0] == PACKET_START_CHAR) && 
			...
			u.pitch = decodeProtocol1616Float(buffer, offset+AHRSPOS_TS_UPDATE_ROLL_VALUE_INDEX);
			u.roll = decodeProtocol1616Float(buffer, offset+AHRSPOS_TS_UPDATE_PITCH_VALUE_INDEX);
    ...
    public static int decodeAHRSPosTSRawUpdate( byte[] buffer, 
		...
		if ( (buffer[offset+0] == PACKET_START_CHAR) && 
			...
			u.pitch = decodeProtocol1616Float(buffer, offset+AHRSPOS_TS_RAW_UPDATE_ROLL_VALUE_INDEX);
			u.roll = decodeProtocol1616Float(buffer, offset+AHRSPOS_TS_RAW_UPDATE_PITCH_VALUE_INDEX);
